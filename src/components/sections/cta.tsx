...
export default function CTASection() {
  const shopUrl = process.env.NEXT_PUBLIC_SHOPEE_SHOP_URL;
      ...
      <div className="relative bg-[#1A1A1A] rounded-3xl overflow-hidden px-6 sm:px-12 md:px-20 py-16 sm:py-20 md:py-24">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-white/70 text-sm sm:text-base leading-relaxed">
            Temukan rangkaian lengkap campuran cocopeat khusus kami di toko Shopee resmi.
          </p>
          {shopUrl && (
            <Button
              asChild
              className="bg-[#46EC13] hover:bg-[#3BD410] text-black font-bold h-12 px-8 text-sm sm:text-base"
            >
